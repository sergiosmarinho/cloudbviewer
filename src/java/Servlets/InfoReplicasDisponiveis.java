 ...
 * @author sergio
 */
public class InfoReplicasDisponiveis extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            AcessoBdDadosEspecificos a = new AcessoBdDadosEspecificos();
            ArrayList<String> disponiveis = a.pegaReplicasBanco(db, endereco, porta, usuario, senha);
            String estruturado = "[";
            ...
            estruturado+="]";
            out.print(estruturado);
            //out.print("[{\"name\":\"jack\"},{\"name\":\"john\"},{\"name\":\"joe\"}]");
        }
    }
